...
function toggleDarkMode() {
    ...
    if (darkModeActive) {
        ...
        usuario.classList.add("holdersreg")
        contrasena.classList.add("holdersreg")
        registro.classList.add("holdersreg")
        ...
        usuario.classList.remove("holdersreg")
        contrasena.classList.remove("holdersreg")
